...
#'Next, for what seemed like an unrelated study, participants completed an 8-item questionairre about political beliefs
...
#'
#'The study was conducted at several sites, but only data for one site (Ithica) is included here.
#'
#'@format A data frame with 90 rows and 5 variables:
#'\describe{
#'  \item{sessionid}{Respondent identifier}
#'  \item{location}{Lab that ran the study - \emph{ithica} for all participants in this dataset}
#'  \item{filter}{\emph{exclude} for for participants who didn't pay attention or who failed some other qualification to be in the study, \emph{include} for participants who passed all checks and shoud be analyzed}
#'  \item{flag_group}{\emph{flag prime} for those exposed to the USA flag, \emph{no prime} for those exposed to control images}
#'  \item{flag_dv}{Average of 8-item scale of political conservatism (1-7): low scores indicate liberal attitudes, high scores indicate conservative attitudes}
#'}
#'
#'@source
...
#'
#'The original study to investigate this erffect is:
#'
