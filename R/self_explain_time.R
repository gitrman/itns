...
#'McEldoon, Durkin & Rittle-Johnson examined the benefits of self-explaining for grade school students learning math.
...
#'
#'Data from all 3 conditions is proivded here, graciously shared by the authors.  The scores are % correct on each phase
...
#'  \item{knowledge}{Score on conceputal knowledge test}
#'}
#'
#'@source
