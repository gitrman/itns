...
#'
#'Psychological research suggests that how a question is worded can influence people's judgments.
...
#'  \item{location}{Lab that ran the study.  Equal to "Ithica" for all participants in this dataset.}
