...
#'
#'To measure learning, reflexes were times before (base_M) and 24 hours after the training (lt3_m)
#'
#'This is a simplified data set that contains data for only the trained animals.  In addition,
#'only the pre-test and post-test measures are included.
#'
#'@format A data frame with 14 rows and 4 variables:
#'\describe{
#'  \item{animalid}{ID of the animal}
#'  \item{condition}{Factor with one level - \emph{trained}}
#'  \item{base_m}{Duration (in seconds) of tail-elicited siphon withdrawal reflex, average of 3 measures, taken prior to start of any training}
#'  \item{lt3_m}{Duration (in seconds) of tail-elicited siphon withdrawal reflex, average of 3 measures, taken 24h after start of third round of training}
#'}
#'@source
