...
#'\describe{
#'  \item{violence}{Independent variable with two levels - \emph{(nonviolenet)} or \emph{violent}}
...
#'
#'Hilgard, J. (2015). \emph{Game violence, game difficulty, and 2D:4D digit ratio as predictors of aggressive beahvior}.
